...
//     const intervals = await WorkingHoursInterval.find({
//       doctorID: decryptedToken._id,
//       dayOfWeek: req.body.dayOfWeek,
//     });
//     for (let interval of intervals) {
//       if (
//         (interval.start <= req.body.start && interval.end >= req.body.start) ||
...
//     const updatedInterval = await WorkingHoursInterval.updateOne(
...
//       res
//         .status(400)
//         .send("Something went wrong. The interval could not be updated.");
//     }
...
//     }
//     const decryptedToken = decryptID(req.header("auth-token"));
//     const deleteInterval = await WorkingHoursInterval.deleteOne({
//       _id: req.query.id,
//       doctorID: decryptedToken._id,
//     });
...
//       res
//         .status(400)
//         .send("Something bad happen! The interval could not be deleted!");
//     }
//   } catch (error) {
//     console.error(new Error(error));
//     res.status(400).send(error);
